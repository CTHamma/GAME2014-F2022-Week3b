...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(Mathf.PingPong(Time.time * horizontalSpeed, horizontallLength) - horizontalBoundary.max, transform.position.y, transform.position.z);
    }
}
